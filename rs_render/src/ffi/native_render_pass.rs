...
pub struct NativeWGPURenderPassFunctions {
    pub native_render_pass_set_pipeline: *mut std::ffi::c_void,
    pub native_render_pass_draw: *mut std::ffi::c_void,
    pub native_render_pass_delete: *mut std::ffi::c_void,
}

impl NativeWGPURenderPassFunctions {
    pub fn new() -> NativeWGPURenderPassFunctions {
        NativeWGPURenderPassFunctions {
            native_render_pass_set_pipeline: nativeRenderPassSetPipeline as *mut std::ffi::c_void,
            native_render_pass_draw: nativeRenderPassDraw as *mut std::ffi::c_void,
            native_render_pass_delete: nativeRenderPassDelete as *mut std::ffi::c_void,
        }
    }
}
