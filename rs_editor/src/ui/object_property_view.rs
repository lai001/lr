    ...
    pub fn draw(
        ...
        match selected_object {
            ...
            ESelectedObjectType::SceneNode(scene_node) => {
                ...
                if let Some(mut component) = scene_node.typed_component_mut::<StaticMeshComponent>()
                {
                    ...
                    match &mut component.physics.shape_type {
                        ...
                        rs_engine::physics_ability::EShapeType::Ball(ball) => {
                            is_changed = Self::vec1_widget_mut(&mut ball.radius, ui, t!("Ball"));
                        }
                    ...
                    if is_changed {
                        event = Some(EEventType::UpdatePhysicsShapeType(UpdatePhysicsShapeType {
                            selected_object: selected_object_clone.clone(),
                ...
                if let Some(mut component) = scene_node.typed_component_mut::<CameraComponent>() {
                ...
                if let Some(mut component) = scene_node.typed_component_mut::<CollisionComponent>()
                {
                ...
                if let Some(mut component) = scene_node.typed_component_mut::<SpotLightComponent>()
                {
                ...
                if let Some(mut component) = scene_node.typed_component_mut::<PointLightComponent>()
                {
