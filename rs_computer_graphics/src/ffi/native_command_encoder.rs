...
pub struct NativeWGPUCommandEncoderFunctions {
    pub begin_render_pass: *mut libc::c_void,
    pub finish: *mut libc::c_void,
}

impl NativeWGPUCommandEncoderFunctions {
    pub fn new() -> NativeWGPUCommandEncoderFunctions {
        NativeWGPUCommandEncoderFunctions {
            begin_render_pass: nativeCommandEncoderBeginRenderPass as *mut libc::c_void,
            finish: nativeCommandEncoderFinish as *mut libc::c_void,
        }
    }
}
