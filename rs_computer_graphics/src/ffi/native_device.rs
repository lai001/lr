...
pub struct NativeWGPUDeviceFunctions {
    pub native_create_shader_module: *mut libc::c_void,
    pub native_create_pipeline_layout: *mut libc::c_void,
    pub native_create_render_pipeline: *mut libc::c_void,
    pub native_create_command_encoder: *mut libc::c_void,
}

impl NativeWGPUDeviceFunctions {
    pub fn new() -> NativeWGPUDeviceFunctions {
        NativeWGPUDeviceFunctions {
            native_create_shader_module: nativeDeviceCreateShaderModule as *mut libc::c_void,
            native_create_pipeline_layout: nativeDeviceCreatePipelineLayout as *mut libc::c_void,
            native_create_render_pipeline: nativeDeviceCreateRenderPipeline as *mut libc::c_void,
            native_create_command_encoder: nativeDeviceCreateCommandEncoder as *mut libc::c_void,
        }
    }
}
