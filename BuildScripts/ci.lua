...
do
    on_run(function()
        ...
        os.exec("cargo build --package rs_desktop_standalone --bin rs_desktop_standalone --features standalone --features plugin_v8")
        os.exec("cargo build --package rs_desktop_standalone --bin rs_desktop_standalone --features standalone --features plugin_v8 --release")
