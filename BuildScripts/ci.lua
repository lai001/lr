...
do
    on_run(function()
        ...
        os.exec("cargo build --package rs_editor --bin rs_editor --features editor --features renderdoc --features plugin_shared_lib --features plugin_dotnet --features plugin_v8")
        os.exec("cargo build --package rs_editor --bin rs_editor --features editor --features renderdoc --features plugin_shared_lib --features plugin_dotnet --features plugin_v8 --release")
